...
if(combustivel.tipo.toLocaleLowerCase()=== "etanol"){
  ...
  paragrafo.innerText = `Custo do Consumo em Reais: ${viagem.custoEmReais.toLocaleString("pt-BR" , {
    style: "currency" ,
    currency: "BRL"
  })}  Percorreu: ${viagem.percurso.replace(".",",")} KM e abasteceu ${viagem.consumoLitros.toFixed(2)} Litros`

  //METODO PARA FORMATAR COMO MOEDA(R$)
  
} else {viagem.custoEmReais = viagem.consumoLitros * combustivel.precoGasolina

 //METODO PARA FORMATAR COMO MOEDA(R$)
 paragrafo.innerText = `Custo da Gasolina: ${viagem.custoEmReais.toLocaleString("pt-BR" , {
    style: "currency" ,
    currency: "BRL"
})} Percorreu: ${viagem.percurso.replace(".",",")} KM e abasteceu ${viagem.consumoLitros.toFixed(2)} Litros`
}     
